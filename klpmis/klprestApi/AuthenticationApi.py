...
def KLP_Login(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            if user.is_active:
                ...
                if user.is_superuser or user.is_staff:
                    ...
                    # else redirect to respective paths defined in usrUrl
                    #dictionary based on group.
        ...
        {'user': user, 'title': 'Karnataka Learning Partnership',
        'legend': 'Karnataka Learning Partnership',
        'entry': "Add"},
        context_instance=RequestContext(request))
...
def KLP_Logout_user(request):
    ...
    logout(request)
    return render_to_response('login.html', {'title':
    'Karnataka Learning Partnership', 'legend':
