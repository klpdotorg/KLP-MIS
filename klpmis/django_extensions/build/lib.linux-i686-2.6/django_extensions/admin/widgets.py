...
class ForeignKeySearchInput(ForeignKeyRawIdWidget):
    ...
    class Media:
        ...
        css = {'all': ('django_extensions/css/jquery.autocomplete.css',
               )}
        js = ('django_extensions/js/jquery.js',
    ...
    def render(
        ...
        if attrs is None:
            attrs = {}
        output = [super(ForeignKeySearchInput, self).render(name,
                  value, attrs)]
        ...
        output.append(render_to_string(self.widget_template
                      or ('django_extensions/widgets/%s/%s/foreignkey_searchinput.html'
