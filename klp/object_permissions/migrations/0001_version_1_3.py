...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if not db_table_exists('object_permissions_testmodel_perms'):
            db.create_table('object_permissions_testmodel_perms', (
                ...
                related_name='operms',
                to=orm['object_permissions.TestModel'])),
                ('Perm3', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ('Perm2', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ('Perm1', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ('Perm4', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ('user', self.gf(
                'django.db.models.fields.related.ForeignKey')(
                related_name='TestModel_uperms', null=True,
                to=orm['auth.User'])),
                ('group', self.gf(
                'django.db.models.fields.related.ForeignKey')(
                related_name='TestModel_gperms', null=True,
                to=orm['auth.Group'])),
                ('id', self.gf('django.db.models.fields.AutoField')(
                primary_key=True)),
            ))
        ...
        if not db_table_exists('object_permissions_testmodelchild_perms'):
            db.create_table('object_permissions_testmodelchild_perms', (
                ('obj', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='operms',
                to=orm['object_permissions.TestModelChild'])),
                ('Perm3', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ('Perm2', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ...
                ('user', self.gf(
                'django.db.models.fields.related.ForeignKey')(
                related_name='TestModelChild_uperms', null=True,
                to=orm['auth.User'])),
                ('group', self.gf(
                'django.db.models.fields.related.ForeignKey')(
                related_name='TestModelChild_gperms', null=True,
                to=orm['auth.Group'])),
                ('id', self.gf('django.db.models.fields.AutoField')(
                primary_key=True)),
            ))
        ...
        if not db_table_exists('object_permissions_testmodelchildchild_perms'):
            db.create_table('object_permissions_testmodelchildchild_perms', (
                ('obj', self.gf('django.db.models.fields.related.ForeignKey')(
                related_name='operms',
                to=orm['object_permissions.TestModelChildChild'])),
                ('Perm3', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ('Perm2', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ...
                related_name='TestModelChildChild_uperms', null=True,
                to=orm['auth.User'])),
                ('group', self.gf(
                'django.db.models.fields.related.ForeignKey')(
                related_name='TestModelChildChild_gperms', null=True,
                to=orm['auth.Group'])),
                ('id', self.gf('django.db.models.fields.AutoField')(
                primary_key=True)),
            ))
        ...
        if not db_table_exists('object_permissions_group_perms'):
            db.create_table('object_permissions_group_perms', (
                ('admin', self.gf('django.db.models.fields.BooleanField')(
                default=False, blank=True)),
                ('obj', self.gf('django.db.models.fields.related.ForeignKey')(
    ...
    models = {
        ...
        'object_permissions.group_perms': {
            ...
            'admin': ('django.db.models.fields.BooleanField', [], {
            'default': 'False', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {
            'related_name': "'Group_gperms'", 'null': 'True',
            'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {
            'primary_key': 'True'}),
            ...
            'related_name': "'Group_uperms'", 'null': 'True',
            'to': "orm['auth.User']"})
        },
        ...
        'object_permissions.testmodel_perms': {
            ...
            'Perm1': ('django.db.models.fields.BooleanField', [], {
            'default': 'False', 'blank': 'True'}),
            'Perm2': ('django.db.models.fields.BooleanField', [], {
            'default': 'False', 'blank': 'True'}),
            'Perm3': ('django.db.models.fields.BooleanField', [], {
            'default': 'False', 'blank': 'True'}),
            'Perm4': ('django.db.models.fields.BooleanField', [], {
            'default': 'False', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {
            'related_name': "'TestModel_gperms'", 'null': 'True',
            'to': "orm['auth.Group']"}),
