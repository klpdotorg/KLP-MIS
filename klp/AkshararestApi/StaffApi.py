...
def KLP_Staff_View(request, staff_id):
	...
	resp=KLP_Boundary(queryset = Staff.objects.filter(pk=staff_id), permitted_methods = ('GET', 'POST'), responder = TemplateResponder(template_dir = 'viewtemplates', template_object_name = 'staff',))(request, staff_id, **kwrg)
