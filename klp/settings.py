...
REPORTMAIL_RECEIVER=["dev@klp.org.in","pushparanij@mahiti.org","megha@klp.org.in"]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'klptest',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/akshara/akshara/klp/klp/static_media/'
...
TEMPLATE_DIRS = (
    ...
    '/home/akshara/akshara/klp/klp/schools/templates/'
)
